...
class JGMessagePush extends StatefulWidget {
  const JGMessagePush({super.key});

  @override
  _JGMessagePushState createState() => new _JGMessagePushState();
}

class _JGMessagePushState extends State<JGMessagePush> {
